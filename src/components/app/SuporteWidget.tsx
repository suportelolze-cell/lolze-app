  ...
  if (!aberto) {
    return (
      <button
        ...
        title="Suporte Lolze"
        className="no-print fixed bottom-6 right-6 z-30 flex h-14 w-14 items-center justify-center rounded-full bg-escuro-quente text-bege-principal shadow-lg transition-transform hover:scale-105"
      >
