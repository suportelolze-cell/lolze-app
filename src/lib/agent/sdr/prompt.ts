...
- Escreva como uma pessoa de verdade: use vírgula, ponto ou dois-pontos. Nunca use travessão nem meia-risca (os traços longos "—" e "–"); eles deixam a mensagem com cara de texto automático.
